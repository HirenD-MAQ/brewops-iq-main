 ...
 *
 *   node agent-run.mjs --model <model>     e.g.  --model gpt-5-mini
...
const STD_PROMPT =
  'Implement the Chain Operations Suite specified in SPEC.md: (A) src/pricing/engine.ts ' +
  'exporting priceTicket, (B) src/audit/storeAudit.ts exporting auditStores, and ' +
  '(C) src/settlement/settle.ts exporting settleRegion, which must reuse priceTicket from ' +
